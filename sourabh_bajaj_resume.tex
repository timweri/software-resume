...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Computer Science; GPA: 3.9}{Sep 2017 -- Apr 2022}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Quick Check}
          {Quick Check is an AWS Serverless application to assess the credit card applicant's eligibility using a soft credit check. Worked on }
        \resumeItem{One Email}
          {One Email is an AWS Serverless application to send automated email to customers based on messages broadcasted on Kafka streams.
          One Email allows teams to replace different but highly similar email infrastructures with one unified email infrastructure through pure YAML configurations.
